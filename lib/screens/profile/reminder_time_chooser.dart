        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                gradient: linearGradientOpacity,
          ...
          child: Row(
            ...
            children: [
              WheelChooser.integer(
                ...
                horizontal: false,
                isInfinite: true,
                selectTextStyle: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontFamily: 'SairaCondensed',),
                listHeight: height,
                listWidth: width,
                unSelectTextStyle: const TextStyle(color: Colors.grey, fontFamily: 'SairaCondensed',),
              ),
              WheelChooser.integer(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(text, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20,
            color: isSelected ?  Colors.white : Colors.black, fontFamily: 'SairaCondensed',),),
      ),
    );
  }
}
