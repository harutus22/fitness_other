            ...
            children: [
              ...
              Container(
                child: Row(
                  ...
                  children: [
                    IntrinsicHeight (child: destinationItem(0, loseWeight.tr())),
                    IntrinsicHeight (child: destinationItem(1, buildMuscle.tr())),
                    IntrinsicHeight (child: destinationItem(2, stayFit.tr())),
                  ],
                ),
              ),
              const SizedBox(height: 20,),
