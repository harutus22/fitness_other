  ...
  Widget build(BuildContext context) {
    ...
    if(item['workout_list'] != null){
      if(!editEnter) {
        ...
        workoutModelCount?.workoutModelCount =
            List.of(planModel!.countModelList);
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            Stack(
              children: [
                Align(alignment: Alignment.topLeft, child: backButton(context, isColor: true, backToMain: () {
                  final plan = PlanModel(
                      id: workoutModelCount?.forEdit == true ? workoutModelCount?.id : null,
                      name: title,
                      countModelList: workoutModelCount != null ?workoutModelCount!.workoutModelCount! : [],
                      count: count,
                      ...
                      children: [
                        ...
                        isForSave
                            ? GestureDetector(
                                ...
                                child: ShaderMask(child: const Icon(FinalCreateIcons.edit, size: 18, color: Colors.white,),
                  ...
                  child: Align(
                    ...
                    child: GestureDetector(
                      child: Text(
                        ...
                        style: const TextStyle(color: Colors.black, fontFamily: 'SairaCondensed',),
                      ),
                      onTap: () {
                          isForSave = !isForSave;
                          setState(() {});
                ...
                children: [
                  Expanded(
                    child: Text(
                      ...
                      style: const TextStyle(
                          fontWeight: FontWeight.w600, fontSize: 20, fontFamily: 'SairaCondensed',),
                    ),
                  ),
                  GestureDetector(
                    child: ClipRRect(
                          ...
                          builder: ((context, snapshot) {
                            return SizedBox(
                              ...
                              child: Text(
                                ...
                                style: const TextStyle(
                                    fontSize: 18,
                                    fontWeight: FontWeight.w500, fontFamily: 'SairaCondensed',),
                              ),
                            );
                          }),
                        ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(deleteWorkoutTitle.tr(),
                                    style: TextStyle(
                                        color: Colors.black,
                                    ...
                                    children: [
                                      Expanded(
                                        child: GestureDetector(
                                            ...
                                            child: Container(
                                              ...
                                              child: Text(deleteWorkoutCancel.tr(),
                                                style: TextStyle(
                                      ...
                                      Expanded(
                                        child: GestureDetector(
                                          onTap: (){
                                            setState(() {
                                              workoutModelCount!.workoutModelCount!.removeAt(
                                                  position);
                                              Navigator.of(context).pop();
                                              if (workoutModelCount!.workoutModelCount!.isEmpty) {
                                                databaseHelper.deletePlan(planModel?.id);
                                                saveAndNext(planModel, context);
                                              }
                                            });
                                          },
                                          child: Container(
                                            alignment: Alignment.center,
                                            padding: EdgeInsets.symmetric(vertical: 10),
                                            child: Text(deleteWorkoutDelete.tr(),
                                              style: TextStyle(
