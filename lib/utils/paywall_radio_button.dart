...
class PayWallRadioButton<T> extends StatelessWidget {
  ...
  Widget _buildText() {
    return Text(
      ...
      style: const TextStyle(color: Colors.black, fontSize: 10, fontFamily: 'SairaCondensed',),
    );
  }
